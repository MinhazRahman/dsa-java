...
public class BinaryTreeDemo {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(binaryTree.countAllNodes(binaryTree.root));
		
		System.out.println("Number of leaf nodes: ");
		System.out.println(binaryTree.countLeafNodes(binaryTree.root));
		
		System.out.println("Number of nodes of degree two:");
		System.out.println(binaryTree.countNodesOfDegreeTwo(binaryTree.root));
